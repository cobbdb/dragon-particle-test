...
(function e(t, n, r) {
    ...
    16: [ function(require, module, exports) {
        (function(global) {
            var Counter = require("./util/id-counter.js"), Rectangle = require("./geom/rectangle.js"), Point = require("./geom/point.js"), Item = require("./item.js"), Mouse = require("./io/mouse.js"), canvas = require("./io/canvas.js"), Util = require("./util/object.js");
            module.exports = function(opts) {
    ...
    17: [ function(require, module, exports) {
        ...
        "./geom/vector.js": 27,
        "./heartbeat.js": 29,
        "./interface/eventable.js": 30,
        "./interface/fadeable.js": 31,
        "./io/canvas.js": 32,
        "./io/keyboard.js": 33,
        "./io/mouse.js": 34,
        "./particle/emitter.js": 40,
        "./particle/square.js": 41,
        "./screen.js": 42,
        "./sprite.js": 43,
        "./ui/button.js": 44,
        "./ui/label.js": 45,
    ...
    19: [ function(require, module, exports) {
        ...
        module.exports = Collection().add([ require("./mask/screentap.js"), require("./mask/screendrag.js"), require("./mask/screenhold.js"), CollisionItem({
            ...
            mask: Rectangle(Point(canvas.width, 0), Dimension(20, canvas.height)),
            collisionSets: dragonCollisions
        }), CollisionItem({
            name: "screenedge/bottom",
            mask: Rectangle(Point(0, canvas.height), Dimension(canvas.width, 20)),
            collisionSets: dragonCollisions
        }), CollisionItem({
            name: "screenedge/left",
            mask: Rectangle(Point(-20, 0), Dimension(20, canvas.height)),
            collisionSets: dragonCollisions
        }) ]);
    }, {
        "./collection.js": 14,
        ...
        "./geom/rectangle.js": 25,
        "./io/canvas.js": 32,
        "./mask/screendrag.js": 36,
        "./mask/screenhold.js": 37,
    ...
    30: [ function(require, module, exports) {
        ...
        module.exports = function(opts) {
            ...
            for (name in opts.events) {
                events[name] = [].concat(opts.events[name]);
            }
            for (name in opts.singles) {
                singles[name] = [].concat(opts.singles[name]);
            }
    ...
    39: [ function(require, module, exports) {
        (function(global) {
            var ClearSprite = require("../clear-sprite.js"), Vector = require("../geom/vector.js"), Dimension = require("../geom/dimension.js"), Point = require("../geom/point.js"), canvas = require("../io/canvas.js"), random = require("../util/random.js"), Util = require("../util/object.js");
        ...
        (function(global) {
            ...
            module.exports = function(opts) {
                ...
                return Collection(opts).extend({
                    speed: opts.speed || 4,
                    _create: function() {
                        hash = global.setInterval(step.bind(this), 1e3 / this.speed);
                    },
                    kill: function() {
    ...
    52: [ function(require, module, exports) {
        ...
        $.loadAssets(function() {
            $.debug();
            $.addScreens([ require("./screens/stage.js") ]);
        });
    }, {
        "./screens/stage.js": 53,
        dragonjs: 17
